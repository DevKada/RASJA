      ...
      <div class="row g-4">
        ...
        <div class="col-md-3">
          <div class="job-card">
            ...
            <div class="company-box d-flex align-items-center mt-4 px-3 py-2 rounded" style="background-color: <?= $color ?>;">
              <div class="company-logo me-2 bg-black text-white rounded-circle d-flex justify-content-center align-items-center">Logo</div>
              <div>
